...
import { vingobotClient } from "@/lib/vingobot-client";
...
type BootState =
  ...
  | {
      status: "ready";
      client: vingobotClient;
      token: string;
      modelName: string | null;
    };

const SIDEBAR_STORAGE_KEY = "vingobot-webui.sidebar";
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const client = new vingobotClient({
          url,
          onReauth: async () => {
            try {
