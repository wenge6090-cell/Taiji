...
def get_config_path() -> Path:
    ...
    # loader.py is at vingobot/config/loader.py → project-root/.vingobot/config.json
    return Path(__file__).parent.parent.parent / ".vingobot" / "config.json"
...
def _apply_ssrf_whitelist(config: Config) -> None:
    ...
    from vingobot.security.network import configure_ssrf_whitelist
