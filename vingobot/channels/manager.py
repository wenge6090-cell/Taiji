...
from vingobot.utils.restart import consume_restart_notice_from_env, format_restart_completed_message
...
def _default_webui_dist() -> Path | None:
    ...
    try:
        import vingobot.web as web_pkg  # type: ignore[import-not-found]
    except ImportError:
        return None
