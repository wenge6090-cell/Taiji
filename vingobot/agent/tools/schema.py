"""JSON Schema fragment types: all subclass :class:`~vingobot.agent.tools.base.Schema` for descriptions and constraints on tool parameters.

- ``to_json_schema()``: returns a dict compatible with :meth:`~vingobot.agent.tools.base.Schema.validate_json_schema_value` /
  :class:`~vingobot.agent.tools.base.Tool`.
...
Shared validation and fragment normalization are on the class methods of :class:`~vingobot.agent.tools.base.Schema`.
...
from vingobot.agent.tools.base import Schema
