"""MCP client: connects to MCP servers and wraps their tools as native vingobot tools."""
...
class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as a vingobot Tool."""
...
class MCPResourceWrapper(Tool):
    """Wraps an MCP resource URI as a read-only vingobot Tool."""
...
class MCPPromptWrapper(Tool):
    """Wraps an MCP prompt as a read-only vingobot Tool."""
