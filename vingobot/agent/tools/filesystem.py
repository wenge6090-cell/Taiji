...
from vingobot.agent.tools.schema import BooleanSchema, IntegerSchema, StringSchema, tool_parameters_schema
from vingobot.agent.tools.file_state import FileStates, _hash_file, current_file_states
from vingobot.utils.helpers import build_image_content_blocks, detect_image_mime
...
class ReadFileTool(_FsTool):
    ...
    def _read_office_doc(self, fp: Path) -> str:
        from vingobot.utils.document import extract_text
