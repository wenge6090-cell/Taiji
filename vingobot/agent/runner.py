...
from vingobot.agent.tools.ask import AskUserInterrupt
...
from vingobot.utils.helpers import (
...
from vingobot.utils.runtime import (
...
class AgentRunner:
    ...
    async def _request_model(
        ...
        if timeout_s is None:
            ...
            # Set VINGOBOT_LLM_TIMEOUT_S=0 to disable.
            raw = os.environ.get("VINGOBOT_LLM_TIMEOUT_S", "300").strip()
            try:
                timeout_s = float(raw)
