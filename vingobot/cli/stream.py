...
class ThinkingSpinner:
    """Spinner that shows 'vingobot is thinking...' with pause support."""

    def __init__(self, console: Console | None = None):
        c = console or _make_console()
        self._spinner = c.status("[dim]vingobot is thinking...[/dim]", spinner="dots")
        self._active = False
