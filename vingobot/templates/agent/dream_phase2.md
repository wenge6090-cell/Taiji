...
- [SKILL] entries: create a new skill under .taiji/cognition/skills/<name>/SKILL.md using write_file

## File paths (relative to workspace root)
- SOUL.md
- USER.md
- memory/MEMORY.md
- .taiji/cognition/skills/<name>/SKILL.md (for [SKILL] entries only)
...
- Use write_file to create .taiji/cognition/skills/<name>/SKILL.md
