...
graph TD
    subgraph "太极: 单Agent多姿态切换"
        ...
        T4 --> T5["第5轮: 思变决策<br/>决策: 继续收集Codex的补充数据<br/>姿态调整: 保持乾卦"]
        ...
        T8 --> T9["第9轮: 思变决策<br/>决策: 进入分析阶段<br/>姿态切换: 离卦·明照"]
...
2. **自适应切换**——思变根据实际情况决定"继续收集"还是"开始撰写"——不需要 Manager 介入
