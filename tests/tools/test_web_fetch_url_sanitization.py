...
from vingobot.agent.tools.web import WebFetchTool, _validate_url
...
def _patch_env():
    return patch("vingobot.security.network.socket.getaddrinfo", _fake_resolve_public), \
           patch("vingobot.agent.tools.web.httpx.AsyncClient", FakeClient)
