...
import vingobot.agent.tools.mcp as mcp_mod
from vingobot.agent.tools.mcp import (
    MCPPromptWrapper,
    MCPResourceWrapper,
    MCPToolWrapper,
...
from vingobot.config.schema import MCPServerConfig
...
async def test_connect_mcp_servers_enabled_tools_warns_on_unknown_entries(
    ...
    monkeypatch.setattr("vingobot.agent.tools.mcp.logger.warning", _warning)
...
async def test_connect_mcp_servers_logs_stdio_pollution_hint(
    ...
    monkeypatch.setattr("vingobot.agent.tools.mcp.logger.error", _error)
