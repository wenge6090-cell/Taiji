...
class TestSubagentHookStatus:
    ...
    async def test_after_iteration_updates_status(self):
        ...
        from vingobot.agent.subagent import SubagentStatus, _SubagentHook
        from vingobot.agent.hook import AgentHookContext
    ...
    async def test_after_iteration_no_status_is_noop(self):
        ...
        from vingobot.agent.subagent import _SubagentHook
        from vingobot.agent.hook import AgentHookContext
...
class TestRuntimeVarsInspectFallback:
    ...
    async def test_inspect_runtime_var_string(self):
        tool = _make_tool()
        await tool.execute(action="set", key="current_project", value="vingobot")
