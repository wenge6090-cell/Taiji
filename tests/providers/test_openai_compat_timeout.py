...
def test_openai_compat_provider_sets_timeout_on_local_http_client() -> None:
    ...
    with (
        patch("vingobot.providers.openai_compat_provider.AsyncOpenAI") as mock_async_openai,
        patch(
            "vingobot.providers.openai_compat_provider.httpx.AsyncClient",
...
def test_openai_compat_provider_timeout_can_be_overridden_by_env(monkeypatch) -> None:
    monkeypatch.setenv("VINGOBOT_OPENAI_COMPAT_TIMEOUT_S", "45")
