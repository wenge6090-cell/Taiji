...
table, allowing vingobot to send multiple cards instead of failing.
"""

# Check optional Feishu dependencies before running tests
try:
    from vingobot.channels import feishu
...
from vingobot.channels.feishu import FeishuChannel
